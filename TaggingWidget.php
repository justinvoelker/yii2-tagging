 ...
 */
class TaggingWidget extends Widget
{
    /**
     * @var array key=>value pairs of tags=>frequency. If multiple TaggingWidgets will
     * use the same data on the same page, TaggingQuery can be used to first generate
     * the item list which can then be passed to TaggingWidget for display.
     */
    public $items;
    /**
    ...
    public $unit = 'px';
    /**
     * @var string format of the returned tags. Options are 'cloud', 'ul',  or 'ol'.
     * Cloud will return a tag cloud with font-sizes adjusted according to their count
     * (frequency). 'ul' and 'ol' will return the appropriate list that can be
     * formatted as desired. If 'ol' is specified, a 'type' will likely be desired as
     * a 'ulOptions' value.
     */
    public $format = 'cloud';
    /**
     * @var string the route that will be used as a base onto which 'urlParam' and the
     * tag name will be appended.
     */
    public $url;
    /**
     * @var string the URL parameter that will be used with the tag and appended to URL.
     */
    public $urlParam;
    /**
     * @var string options that are to be assigned to the ul or ol in the tag cloud or
     * list.
     */
    public $listOptions = array();
    /**
     * @var string options that are to be assigned to each list item (li) in the tag
     * cloud or list.
     */
    public $liOptions = array();
    /**
     * @var string options that are to be assigned to each link (a) in the tag cloud or
     * list.
     */
    public $linkOptions = array();
    /**
     * @var array the minimum frequency found for all tags which is used as the basis
     * for increasing the font-size of more frequent tags.
     */
    private $_minCount;
    /**
